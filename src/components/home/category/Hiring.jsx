...
function Hiring() {
  ...
  return (
    <div className="container flex justify-center items-center pt-0 ">
      {/* Hiring Inof */}
      <div className="flex w-[90%] justify-evenly items-center border border-bgDeepBlue rounded-lg shadow-sm flex-col lg:flex-row p-5 space-y-3 lg:gap-3 bg-white dark:bg-darkBlue dark:text-white">
        ...
        <div className="flex lg:flex-col gap-2 lg:gap-0   ">
          ...
          <h2 className="lg:mb-10">
            {" "}
            <Trans i18nKey="hiring">HIRING</Trans>
          </h2>
        </div>
