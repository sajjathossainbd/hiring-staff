...
// const NewsBlogCard = ({ title, description, image, writer_name, time_since_read }) => {
//     return (
//         <div className="flex flex-col max-w-lg p-6 space-y-6 overflow-hidden rounded-lg shadow-md dark:bg-gray-50 dark:text-gray-800">
//             <div>
//                 <img src={image} alt="News" className="object-cover w-full mb-4 h-60 sm:h-96 dark:bg-gray-500" />
//                 <h2 className="mb-1 text-xl font-semibold">{title}</h2>
//                 <p className="text-sm dark:text-gray-600">{description}</p>
//             </div>
//             <div className="flex flex-wrap justify-between">
//                 <div className="flex space-x-4">
//                     <img alt={writer_name} src="https://source.unsplash.com/100x100/?portrait" className="object-cover w-12 h-12 rounded-full shadow dark:bg-gray-500" />
//                     <div className="flex flex-col space-y-1">
//                         <a rel="noopener noreferrer" href="#" className="text-sm font-semibold">{writer_name}</a>
//                         <span className="text-xs dark:text-gray-600">{time_since_read}</span>
//                     </div>
//                 </div>
//                 <div className="flex space-x-2 text-sm dark:text-gray-600">
//                     <button type="button" className="flex items-center p-1 space-x-1.5">
//                         {/* SVG icons for comments */}
//                         <span>30</span>
//                     </button>
//                     <button type="button" className="flex items-center p-1 space-x-1.5">
//                         {/* SVG icons for likes */}
