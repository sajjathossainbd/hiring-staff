        ...
        <div className="w-full lg:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-6">
          {
            contents.map((content, id) => (
              <Link to={`/blog-details/${content.id}`} key={id} className="border-[.5px] border-lightGray hover:border-blue rounded-lg px-1 py-3  hover:-translate-y-1 transition duration-300 h-[600px] md:h-[500px] lg:h-[611px] w-full">
                ...
                <div className="card-body p-4 gap-1 mt-3">
                  ...
                  <div className="flex justify-between items-end mt-6">
                    <div className="flex items-center gap-4">
                      ...
                      />
                      <div>
                        <h5 className="lg:text-14 text-xs">{content.writer_name}</h5>
                        <p className="lg:text-12 text-[11px] lg:mt-1">{content.date}</p>
                      </div>
                    </div>
