...
function PrimaryBtn({ title, icon }) {
  return (
    <div className="relative inline-flex items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all bg-blue dark:border dark:border-white rounded-md group cursor-pointer">
