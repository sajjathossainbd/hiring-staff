...
<<<<<<< HEAD
    ...
    const fetchUsers = async (currentPage, limit) => {
        const response = await axiosInstance.get(`/users?page=${currentPage}&limit=${limit}`);
                ...
                <table className="table text-sm">
                    ...
                    <tbody>
                        {usersData?.map((user) => (
                            <tr key={user._id}>
                                <td>{user.name}</td>
                                <td><span className="text-blue">{user.email}</span></td>
                                <td>
                                    <a className="hover:text-blue hover:underline" target="_blank" href={user.linkedin}>Linkedin</a>
                                </td>
                                <td>
                                    <select
                                ...
                                <td>
                                    <button onClick={() => handleDelete(user._id)} className="btn rounded-full text-blue hover:text-white hover:bg-blue">
                                        <RiDeleteBin6Line />
                                    </button>
                                </td>
                            </tr>
...
>>>>>>> 32d49998b4735259d0a485964e3619b93998e4cc
    );
    return response.data;
  };
