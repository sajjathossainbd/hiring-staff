    ...
    <div>
      ...
      <div className="relative">
        <img
          src={imageCenter}
          alt="Main Background"
          className="rounded-xl w-[482px] h-[435px]"
        />
        ...
        <div className="absolute -bottom-44 -right-36 hidden md:block ">
          ...
          <div className=" w-full md:w-1/2 px-10">
            <h1 className="text-2xl lg:text-4xl font-bold text-lightGray">Million's Of Jobs.</h1>
            <h1 className="text-3xl lg:text-5xl font-bold w-full text-darkBlue py-2">
              Find The One That’s <span className="text-blue">Right</span> For You
            </h1>
            <p className="py-6">
            ...
            <button style={{ color: 'white' }}  className="btn bg-blue hover:bg-darkBlue ">Search Jobs</button>
            <a className="px-4">Learn more</a>
          </div>
        </div>
      </div>
      <div>
